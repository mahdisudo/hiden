...
define('BOT_TOKEN', '263503443:AAE_eGJM-f6BWU8OR4VBLdXjR4ozGBb2EmA');
...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://hiden-morphin.rhcloud.com/'.$chat_id.'/pvresan.php');
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://hiden-morphin.rhcloud.com/'.$chat_id.'/pvresan.php');
...
.";
    ...
    $bot_url    = "https://api.telegram.org/bot263503443:AAE_eGJM-f6BWU8OR4VBLdXjR4ozGBb2EmA/"; 
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=https://hiden-morphin.rhcloud.com/'.$id.'/pvresan.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
.";
